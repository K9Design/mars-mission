...
I decided to make the two main scripts Rover and MapController as functional classes. The idea was to keep the code open for multible instances of Rovers and future vehicles with a static map to keep an overview.
